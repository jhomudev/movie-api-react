    ...
    <main className='main px-3 grid gap-6 grid-cols-[repeat(auto-fit,minmax(160px,1fr))]'>
      {
        movies.map((movie) => (
          <article key={movie.id} className='movie group w-full text-left flex flex-col items-center sm:items-start gap-2 font-dosis'>
            <div className='imgBox relative grid place-items-center w-[min(100%,210px)] h-screen max-h-[260px] object-fill rounded-md overflow-hidden'>
